// Nhấn 1: Đổi tên nhân vật => Mất gold (20)
// Nhấn 2: Nạp gold
// Nhấn 3: Tăng sức mạnh +20 => Mất gold (50)
// Nhấn 4: Hiển thị thông tin của hệ
// Nhấn 5: Xem danh sách các đồ vật trong túi

// Hỏi người dùng muốn thực hiện thao tác gì
...
//   class: {
//     nameClass: "god",
//     locationClass: "Olympus",
//   },
//   backpack: ["sword", "armor", "gun"],
// };

// let ques = Number(
//   prompt(
//     "1: Change name || 2: Add Gold || 3: More Power || 4: All Class || 5: Show Backpack"
//   )
// );
// switch (ques) {
//   case 1:
//     let nameCharacter = prompt("Nhap ten ban muon doi: ");
//     character[name] = nameCharacter;
//     if (character.gold < 20) {
//       alert("Ngu dốt! Nạp tiền đi");
//     } else {
//       character[gold] = gold - 20;
//     }
//     break;
//   case 2:
//     let newGold = Number(prompt("Input number of Gold: "));
...
//       alert("Ngu dốt! Nạp tiền đi");
//     } else {
//       character[power] = powerCharacter + 20;
//       alert(`Tham lam. Power up to: ${character.power}`);
//     }
      //  break;
//   case 4:
//       character['description'] = "Class này mạnh vãi chưởng"
//       alert(`Thong tin: ${character.description}`)
//     break;
//   case 5:
//     alert(`Backpack: ${character.backpack}`)
//     break
//   default:
...
// 2. Learn about destructing object in the following tutorials:
// const task = {
...
//       categoryVIs: ["Công nghệ cao", "IT - Phần mềm", "Internet/Online Media"],
...
//       categories: ["Internet/Online Media", "High Technology", "IT - Software"],
//       salaryMin: 500,
...
//       categoryVIs: ["Công nghệ cao", "IT - Phần mềm", "IT-Phần cứng/Mạng"],
...
// 3.2: The "hits" properly is Array
// 3.3: In each hit of hits, we can use map to find

// let map1 = jobSearch.hits.map((item) => item.jobTitle);
// console.log(map1);

// let map2 = jobSearch.hits.map((item) => item.locations);
// console.log(map2);

// let map3 = jobSearch.hits.map((item) => item.jobSalary);
// console.log(map3);

// let map4 = jobSearch.hits.map((item) => item.benefits);
// console.log(map4);

// let map5 = jobSearch.hits.map((item) => item.skills);
// console.log(map5);

// let map6 = jobSearch.hits.map((item) => item.jobRequirement);
// console.log(map6);
...
// do {
//   alert(
//     "Hi there, this is online library \n Here a list: \n 1. debug \n 2. done \n 3. defect \n 4. pm \n 5. uiux"
//   );
//   let library = {
//     debug:
...
//   };
//   let welcome = prompt("Enter a keyword: ");

//   if (library[welcome]) {
//     alert(`Your search: ${welcome} \n${library[welcome]}`);
//   } else {
//     let description = prompt(`We could not find your keywork: ${welcome}, leave your explanation`);
//     library[welcome] = description
//     alert("Done")
//     alert(`Your search: ${welcome} \n${library[welcome]}`);
//   }
...
// do {
//   let input = prompt("Enter product you want to get detail: ");
//   if (list[input]) {
//     console.log(`============================`);
//     console.log(`Name: ${list[input].Name}`);
//     console.log(`Brand: ${list[input].Brand}`);
//     console.log(`Price: ${list[input].Price}`);
//     console.log(`Color: ${list[input].Color}`);
//     console.log(`Category: ${list[input].Category}`);
//   } else {
...
// do {
//   let input1 = prompt("Enter you category: ");
//     if () {
//       console.log(`============================`);
//       console.log(`${list[input1]}: ${list[input1].Name}`);
//       console.log(`Price: ${list[input1].Price}`);
//     }
...
//   },
//   {
//     nameClass: "Basics of JavaScript",
//     complete: "false"
//   },
//   {
//     nameClass: "Node Package Manager (npm)",
//     complete: "false"
//   },
//   {
//     nameClass: "Git",
...
//   console.log(`${i}. ${subject[i].nameClass}`);
//   console.log(`Complete: ${subject[i].complete}`);
// }
// console.log("=====================================");
...
//     subject.push({nameClass: newTask, complete: "false"})
//     for(let i in subject){
//       console.log(`${i}. ${subject[i].nameClass}`);
//       console.log(`Complete: ${subject[i].complete}`);
//     }
...
//     break;
//   case 2:
//     let checkPos = Number(prompt("Enter position to update: "));
//     let newTitle = prompt("Enter new title: ")
//     subject[checkPos - 1].nameClass = newTitle
//     for(let i in subject){
//       console.log(`${i}. ${subject[i].nameClass}`);
//       console.log(`Complete: ${subject[i].complete}`);
//     }
...
//     break;
//   case 3:
//     let pos = Number(prompt("Enter position to delete : ")) 
//     delete subject[pos - 1]
//     for(let i in subject){
//       console.log(`${i}. ${subject[i].nameClass}`);
//       console.log(`Complete: ${subject[i].complete}`);
//     }
...
//     break;
//   case 4:
//     let inputPos = Number(prompt("Enter position to change status to true: "));
//     subject[inputPos - 1].complete = "true"
//     for(let i in subject){
//       console.log(`${i}. ${subject[i].nameClass}`);
//       console.log(`Complete: ${subject[i].complete}`);
//     }
